...
import icon from '../../resources/icon.png?asset'; // eslint-disable-line import/no-unresolved
...
app.whenReady().then(() => {
  ...
  const users = [
    { id: 1, name: 'Юзер', secondName: 'Юзеров' },
    { id: 2, name: 'Пример', secondName: 'Примеров' },
  ];
